...
public static partial class Tasks
{
    ...
    {
        return Emps
            .Where(x => x.Job == "Frontend programmer").MaxBy(x => x.HireDate);
    }
    ...
    public static IEnumerable<Dept> Task14()
    {
        return Depts
            .GroupJoin(Emps,
                ...
                {
                    Dept = dept,
                    EmployersCount = employees.Count()
                })
            .Where(x => x.EmployersCount == 5 || x.EmployersCount == 0)
            .Select(x => x.Dept)
            .OrderBy(x => x.Dname);
    }
}